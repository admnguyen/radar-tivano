...
from .models import Aircraft, Pilot, PDTPage, FlightOperation, AircraftReservation
...
@admin.register(AircraftReservation)
class AircraftReservationAdmin(admin.ModelAdmin):
    list_display = [
        'aircraft',
        'get_pilot_name',
        'start_datetime',
    ...
    list_filter = ['aircraft', 'pilot']
    search_fields = [
        'aircraft__registration_marks',
        'pilot__user__last_name',
        'pilot__user__first_name',
    ]
    autocomplete_fields = ['aircraft', 'pilot']
    date_hierarchy = 'start_datetime'

    fieldsets = (
        ('Rezerwacja', {
            'fields': ('aircraft', 'pilot')
        }),
        ('Czas', {
