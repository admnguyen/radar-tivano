...
urlpatterns = [
    ...
    path('pdt/<int:pk>/photo/download/', views.download_pdt_photo, name='download_pdt_photo'),
    ...
    path('schedule/create/', views.create_reservation, name='create_reservation'),
    path('schedule/<int:pk>/delete/', views.delete_reservation, name='delete_reservation'),
]